...
@router.put("/{character_id}", response_model=CharacterOutSchema, status_code=status.HTTP_200_OK)
async def update_character(
    ...
    try:
        updated_character = await service.update(character_id=character_id, data=data)
